"""
Django settings for team_Tomorrow project.
...
SECRET_KEY = "django-insecure-)us=+eppc+cpb=r5_q(^)grliz4=o227hnd9f(nlr-i7k@(s%&"
...
WSGI_APPLICATION = "team_Tomorrow.wsgi.application"
